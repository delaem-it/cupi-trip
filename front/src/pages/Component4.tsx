...
const Component4: FunctionComponent = () => {
  ...
  const onButtonClick = useCallback(() => {
    // Please sync "Билеты-Туда и обратно-Без пересадок" to the project
  }, []);
        ...
        <div className={styles.headerCatalogTickets}>
          ...
          <div className={styles.home}>
            <header className={styles.header}>
              <img className={styles.icon} alt="" src="../icons/----27.svg" />
          ...
          <div className={styles.tickets1}>
            <div className={styles.iconheading}>
              <div className={styles.headingsubtitle}>
                <div className={styles.div25}>Ищем для вас лучшие билеты!</div>
          ...
          <div className={styles.footer1}>
            <div className={styles.links}>
              <div className={styles.logo}>
                <img className={styles.icon} alt="" src="../icons/----28.svg" />
              ...
              <div className={styles.frameLink}>
                <div className={styles.waytimeavia}>
                  <div className={styles.div25}>Помощь</div>
                ...
                <div className={styles.frameLink2}>
                  <div className={styles.div25}>Сотрудничество</div>
              ...
              <div className={styles.frameLink3}>
                <div className={styles.div25}>Клиентам</div>
                <div className={styles.link6}>
                  <div className={styles.link7}>
              ...
              <div className={styles.frameDiv10}>
                <div className={styles.frameLink4}>
                  <div className={styles.div27}>Мы в социальных сетях</div>
                  <div className={styles.socialNetworks}>
                    <button className={styles.iconButton}>
                      <img
                        className={styles.icons20px1}
                        alt=""
                        src="../icons/icons-20px11.svg"
                      />
                    </button>
                    <button className={styles.iconButton}>
                      <img
                        className={styles.icons20px1}
                        alt=""
                        src="../icons/icons-20px12.svg"
                      />
                    </button>
                  </div>
                </div>
                <div className={styles.frameLink4}>
                  <div className={styles.div27}>Мы принимаем</div>
            ...
            <div className={styles.links1}>
              <div className={styles.div33}>©“КУПИТРИП”2014-2022</div>
