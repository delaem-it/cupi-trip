          ...
          <div className={styles.filtertickets}>
            <div className={styles.filter}>
                    ...
                    <div className={styles.group}>
                      ...
                      <div className={styles.lineFilter}>
                        ...
                        <div className={styles.line}>
                          ...
                          <div className={styles.point1}>
                            <img className={styles.bulletIcon} alt="" />
                            <img className={styles.bulletIcon} alt="" />
                          </div>
                        </div>
                      </div>
              ...
              <button className={styles.arrowFuther}>
                <img className={styles.icons16px} alt="" />
            ...
            <div className={styles.tickets1}>
              ...
              <div className={styles.ticket}>
                <div className={styles.waytimeavia}>
                  <div className={styles.avia}>
                    <img className={styles.logoIcon7} alt="" />
              ...
              <div className={styles.ticket}>
                <div className={styles.waytimeavia}>
                  <div className={styles.avia}>
                    <img className={styles.logoIcon7} alt="" />
                    <div className={styles.div53}>Lufthansa</div>
                  </div>
                  <div className={styles.waytime}>
                    <div className={styles.way}>
                      <div className={styles.timesubtitle}>
          ...
          <footer className={styles.footer}>
            <div className={styles.footer1}>
              <div className={styles.links}>
                ...
                <div className={styles.frameLink}>
                  <div className={styles.frameLink1}>
                    <div className={styles.div110}>Помощь</div>
                  ...
                  <div className={styles.frameLink2}>
                    <div className={styles.div110}>Сотрудничество</div>
                ...
                <div className={styles.frameLink3}>
                  <div className={styles.div110}>Клиентам</div>
                  <div className={styles.link}>
                    <div className={styles.link1}>
                ...
                <div className={styles.frameDiv20}>
                  <div className={styles.frameLink4}>
                    <div className={styles.div54}>Мы в социальных сетях</div>
                    <div className={styles.socialNetworks}>
                      <button className={styles.iconButton}>
                        <img className={styles.icons20px27} alt="" />
                      </button>
                      <button className={styles.iconButton}>
                        <img className={styles.icons20px27} alt="" />
                      </button>
                  ...
                  <div className={styles.frameLink4}>
                    <div className={styles.div54}>Мы принимаем</div>
                    <div className={styles.socialNetworks1}>
                      <img className={styles.visaIcon} alt="" />
                      <img className={styles.groupIcon} alt="" />
                      <img className={styles.mirLogo1Icon} alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.links1}>
                <div className={styles.div115}>©“КУПИТРИП”2014-2022</div>
                <div className={styles.links2}>
                  <div className={styles.div3}>Договор оферты</div>
                  <div className={styles.div3}>
