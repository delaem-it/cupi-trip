        ...
        <div className={styles.headerCatalogTickets}>
          ...
          <div className={styles.home}>
            <header className={styles.header}>
              <img className={styles.icon} alt="" src="../icons/----22.svg" />
                  ...
                  <div className={styles.field3} onClick={onField3Click}>
                    <div className={styles.subtitleheading2}>
                      <div className={styles.subtitleheading3}>
                        <div className={styles.div108}>Дата туда</div>
                    ...
                    <img
                      className={styles.icons16px}
                      alt=""
                      src="../icons/icons-16px38.svg"
                    />
                  </div>
                  <div className={styles.line19}>
                    <div className={styles.rectangleDiv45} />
                  </div>
                  <button className={styles.field4} onClick={onField4Click}>
                    <div className={styles.subtitleheading2}>
                      <div className={styles.subtitleheading3}>
                        <div className={styles.div110}>Дата обратно</div>
                        <div className={styles.div111}>29 мая</div>
                      </div>
                    </div>
                    <img
                      className={styles.icons16px}
                ...
                <div className={styles.fieldsearchmobile}>
                  <div className={styles.field6}>
                    <div className={styles.subtitleheading}>
                      ...
                      <div className={styles.div116}>Москва</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
                  ...
                  <div className={styles.field6}>
                    <div className={styles.subtitleheading}>
                      ...
                      <div className={styles.div116}>Рим</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
                  ...
                  <div className={styles.fieldsData}>
                    <div className={styles.field8}>
                      <div className={styles.subtitleheading}>
                        ...
                        <div className={styles.div116}>23 мая</div>
                      </div>
                      <img
                        className={styles.icons16px}
                        alt=""
                    ...
                    <div className={styles.field8}>
                      <div className={styles.subtitleheading}>
                        ...
                        <div className={styles.div116}>24 мая</div>
                      </div>
                      <img
                        className={styles.icons16px}
                        alt=""
                  ...
                  <div className={styles.field6}>
                    <div className={styles.subtitleheading}>
                      ...
                      <div className={styles.div116}>1 пассажир</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
