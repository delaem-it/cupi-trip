...
const Component6: FunctionComponent = () => {
  ...
  const onField9Click = useCallback(() => {
    navigate("/1");
  }, [navigate]);

  const onField10Click = useCallback(() => {
    navigate("/2");
  }, [navigate]);

  const onField11Click = useCallback(() => {
    navigate("/3");
  }, [navigate]);
        ...
        <div className={styles.headerCatalogTickets}>
          ...
          <div className={styles.home}>
            <header className={styles.header}>
              <img className={styles.icon} alt="" src="../icons/----210.svg" />
            ...
            <div className={styles.searchDropdown}>
              <div className={styles.searchFieldbutton}>
                <div className={styles.field}>
                  <AirportSelect
                    fieldBorderRadius="var(--br-md) 0px 0px var(--br-md)"
                    fieldCursor="unset"
                    fieldWidth="auto"
                  />
                  ...
                  <button className={styles.field1} onClick={onField9Click}>
                  ...
                  <button className={styles.field1} onClick={onField10Click}>
                    <div className={styles.subtitleheading}>
                      <div className={styles.div104}>Дата туда</div>
                      <div className={styles.div105}>23 мая</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
                  ...
                  <button className={styles.field3} onClick={onField11Click}>
                  ...
                  <div className={styles.field4}>
                    <div className={styles.subtitleheading}>
                      ...
                      <div className={styles.div111}>1 пассажир</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
                ...
                <div className={styles.fieldsearchmobile}>
                  ...
                  <div className={styles.field6}>
                    <div className={styles.subtitleheading}>
                      ...
                      <div className={styles.div111}>Рим</div>
                    </div>
                    <img
                      className={styles.icons16px}
                      alt=""
                  ...
                  <div className={styles.fieldsData}>
                    <div className={styles.field4}>
                      <div className={styles.subtitleheading}>
                        ...
                        <div className={styles.div111}>23 мая</div>
                      </div>
                      <img
                        className={styles.icons16px}
                        alt=""
                    ...
                    <div className={styles.field4}>
                      <div className={styles.subtitleheading}>
                        ...
                        <div className={styles.div111}>24 мая</div>
                      </div>
                      <img
                        className={styles.icons16px}
                        alt=""
